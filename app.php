...
$telegram = new TelegramHandler($telegramBotToken, $telegramSecretToken, $webhookUrl, $endpointUrl, $botName, $storage);
$server   = new Server("$serverAddr:$serverPort", $telegram);
